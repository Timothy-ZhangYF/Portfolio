...
| • Microcontrollers (ESP32, STM32) | • Model Quantization (TFLite, TFLite Micro, Hailo, IMX500) | • Circuit Simulation (LTspice, Cadence) |
| • Communication Protocols (SPI, I2C, UART) | • Computer Vision (OpenCV, YOLO) | • CAD / Mechanical (SolidWorks CSWA, Fusion, Onshape) |
